...
public class UpgradeWoodToStoneToolsModule implements PaperExtrasModule {
    ...
    public void enable() {
        ...
        recipe = new SmithingRecipe(
                PaperExtras.key("pick_wood_to_stone"),
    ...
    public boolean shouldEnable() {
        boolean shouldEnable = PaperExtras.getPluginConfig().getBoolean("settings.smithing-table.tools.wood-to-stone", false);
