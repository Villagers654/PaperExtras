...
/**
 * If enabled, block list will be used. Key is the block material that will be converted from and
 * value is block material that will be converted to. In default config if anvil falls on a
...
public class AnvilChangesBlocksModule implements PaperExtrasModule, Listener {
  ...
  protected AnvilChangesBlocksModule() {
    ...
    ConfigurationSection section =
        config.getConfigSection("settings.anvil-crushes-blocks.blocks", defaults);
