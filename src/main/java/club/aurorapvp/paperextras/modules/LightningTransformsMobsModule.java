...
public class LightningTransformsMobsModule implements PaperExtrasModule, Listener {
    ...
    protected LightningTransformsMobsModule() {
        ...
        ConfigurationSection section = PaperExtras.getPluginConfig().getConfigSection("settings.lightning-transforms-entities.entities", defaults);
    ...
    public boolean shouldEnable() {
        ...
        return PaperExtras.getPluginConfig().getBoolean("settings.lightning-transforms-entities.enabled", false);
    }
