 ...
 * Requires paperextras.invisibleframes permission.
 */
public class InvisibleItemFrameModule implements PaperExtrasModule, Listener {
    ...
    public boolean shouldEnable() {
        ...
        return PaperExtras.getPluginConfig().getBoolean("settings.blocks.shift-right-click-for-invisible-item-frames", false);
    }
