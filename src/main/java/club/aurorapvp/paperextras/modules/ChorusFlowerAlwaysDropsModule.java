...
public class ChorusFlowerAlwaysDropsModule implements PaperExtrasModule, Listener {
  ...
  public boolean shouldEnable() {
    return PaperExtras.getPluginConfig()
        .getBoolean("settings.blocks.chorus-flowers-always-drop", false);
  }
  ...
  public void entityHitChorusFlower(ProjectileHitEvent event) {
    ...
    if (event.getHitBlock().getType().equals(Material.CHORUS_FLOWER)) {
      ...
      chorusFlower
          .getWorld()
          .dropItem(chorusFlower.getLocation(), new ItemStack(Material.CHORUS_FLOWER));
    }
  }
