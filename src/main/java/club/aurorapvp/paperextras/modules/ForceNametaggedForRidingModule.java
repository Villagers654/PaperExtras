 ...
 */
public class ForceNametaggedForRidingModule implements PaperExtrasModule, Listener {
    ...
    public boolean shouldEnable() {
        return PaperExtras.getPluginConfig().getBoolean("settings.rideables.mob-needs-to-be-nametagged-to-ride", false);
    }
