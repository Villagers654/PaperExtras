...
public class AnvilSplitsMinecartsAndBoatsModule implements PaperExtrasModule, Listener {
    ...
    protected AnvilSplitsMinecartsAndBoatsModule() {
        this.splitMinecarts = PaperExtras.getPluginConfig().getBoolean("settings.anvil-splits-minecarts", false);
        this.splitBoats = PaperExtras.getPluginConfig().getBoolean("settings.anvil-splits-boats", false);
    }
    @Override
    public void enable() {
