...
/**
 * If enabled, totem of undying will save players from death in the void and will teleport them to
 * the last place their feet touched the ground. If for any reason that position is not found, they
 * will be teleported to world spawn.
 */
public class VoidTotemModule implements PaperExtrasModule, Listener {
  ...
  public boolean shouldEnable() {
    return PaperExtras.getPluginConfig().getBoolean("settings.totem.work-on-void-death", false);
  }
  ...
  public void onPlayerDeathInVoid(EntityDamageEvent event) {
    ...
    Location safeLocation =
        lastGroundedLocations.getOrDefault(
